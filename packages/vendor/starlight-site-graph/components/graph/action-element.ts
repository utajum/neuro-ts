...
export function renderActionContainer(context: GraphComponent) {
  ...
  for (const action of context.config.actions) {
    ...
    if (action === "fullscreen") {
      actionElement.innerHTML = context.isFullscreen
        ? icons.minimize
        : icons.maximize;
        ...
        showContextMenu(e, [
          {
            text: "Minimize",
            icon: icons.minimize,
            onClick: () => context.disableFullscreen(),
          },
          {
            text: "Maximize",
            icon: icons.maximize,
            onClick: () => context.enableFullscreen(),
          },
        ]);
      };
      ...
      actionElement.innerHTML = context.config.renderArrows
        ? icons.arrow
        : icons.line;
        ...
        showContextMenu(e, [
          {
            text: "Render Arrows",
            icon: icons.arrow,
            onClick: () => (context.config.renderArrows = true),
          },
          {
            text: "Render Lines",
            icon: icons.line,
            onClick: () => (context.config.renderArrows = false),
          },
        ]);
      };
      ...
      actionElement.innerHTML = context.config.renderExternal
        ? icons.link
        : icons.unlink;
      ...
      actionElement.innerHTML = context.config.renderUnresolved
        ? icons.resolved
        : icons.unresolved;
