  ...
  return {
          ...
          [
            `${color}`,
            {
              properties: {
                ...
                blur:
                  colorConfig[(key + "Muted") as keyof typeof colorConfig] ??
                  colorConfig[color],
              },
          ...
          [
            `${color}Hover`,
            {
              properties: {
                default: colorConfig[color],
                hover:
                  colorConfig[(key + "Hover") as keyof typeof colorConfig] ??
                  colorConfig[color],
              },
              interpolator: new ColorInterpolator(),
              duration: graphConfig.hoverDuration,
          ...
          [
            `${color}Adjacent`,
            {
              properties: {
                default: colorConfig[color],
                adjacent:
                  colorConfig[(key + "Adjacent") as keyof typeof colorConfig] ??
                  colorConfig[color],
              },
              interpolator: new ColorInterpolator(),
              duration: graphConfig.hoverDuration,
    ...
    labelOpacityAdjacent: {
      properties: {
        default: 1,
        adjacent:
          graphConfig.labelAdjacentOpacity ?? graphConfig.labelMutedOpacity,
      },
      interpolator: new NumberInterpolator(),
      duration: graphConfig.hoverDuration,
      easing: easing_functions[graphConfig.hoverEase],
    ...
    linkWidthHover: {
      properties: {
        default: graphConfig.linkWidth,
        hover: graphConfig.linkHoverWidth,
      },
      interpolator: new NumberInterpolator(),
      duration: graphConfig.hoverDuration,
      easing: easing_functions[graphConfig.hoverEase],
    ...
    labelOffset: {
      properties: {
        default: graphConfig.labelOffset,
        hover: graphConfig.labelHoverOffset,
      },
      interpolator: new NumberInterpolator(),
      duration: graphConfig.hoverDuration,
      easing: easing_functions[graphConfig.hoverEase],
