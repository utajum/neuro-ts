...
import {
  globalBacklinksConfigSchema,
  globalBacklinksConfig,
} from "./backlinks";
...
export const starlightSiteGraphConfigSchema = z
  .object({
     ...
     */
    overridePageSidebar: z
      .boolean()
      .default(DEFAULT_GLOBAL_STARLIGHT_CONFIG.overridePageSidebar),
     ...
     * }```
     */
    graphConfig: globalGraphConfigSchema
      .partial()
      .default({ ...DEFAULT_GLOBAL_STARLIGHT_CONFIG.graphConfig }),
     ...
     * }```
     */
    sitemapConfig: globalSitemapConfigSchema
      .partial()
      .default({ ...DEFAULT_GLOBAL_STARLIGHT_CONFIG.sitemapConfig }),
     ...
     * }```
     */
    backlinksConfig: globalBacklinksConfigSchema
      .partial()
      .default({ ...DEFAULT_GLOBAL_STARLIGHT_CONFIG.backlinksConfig }),
  })
  .partial()
  .default({});
