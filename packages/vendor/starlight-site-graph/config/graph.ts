...
const DEFAULT_GRAPH_CONFIG = {
  actions: [
    ...
    "render-arrows",
    "settings",
  ] as (typeof KWD_GRAPH_ACTIONS)[number][],
  tagStyles: {},
...
export const graphConfigSchema = z.object({
   ...
   * ["!secret/**", "**\/*"]
   */
  nodeInclusionRules: z
    .array(z.string())
    .default([...DEFAULT_GRAPH_CONFIG.nodeInclusionRules]),
  ...
  scale: z
    .number()
    .gt(0, "Graph scale may not be zero or negative")
    .default(DEFAULT_GRAPH_CONFIG.scale),
  /**
  ...
  minZoom: z
    .number()
    .gt(0, "Graph zoom may not be zero or negative")
    .default(DEFAULT_GRAPH_CONFIG.minZoom),
  /**
  ...
  maxZoom: z
    .number()
    .gt(0, "Graph zoom may not be zero or negative")
    .default(DEFAULT_GRAPH_CONFIG.maxZoom),
  ...
  minZoomArrows: z
    .number()
    .min(0, "Minimum zoom for arrow rendering may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.minZoomArrows),
  ...
  labelOpacityScale: z
    .number()
    .min(0, "Opacity scale for labels may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelOpacityScale),
  /**
  ...
  labelMutedOpacity: z
    .number()
    .min(0, "Opacity scale for muted labels may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelMutedOpacity),
  /**
  ...
  labelHoverOpacity: z
    ...
    .default(DEFAULT_GRAPH_CONFIG.labelHoverOpacity),
  /**
  ...
  labelAdjacentOpacity: z
    ...
    .min(0, "Opacity scale for hovered labels may not be negative")
    .optional()
    .default(DEFAULT_GRAPH_CONFIG.labelAdjacentOpacity),
  /**
  ...
  labelFontSize: z
    .number()
    .min(0, "Label font size may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelFontSize),
  /**
  ...
  labelHoverScale: z
    .number()
    .min(0, "Label hover scale may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelHoverScale),
  /**
  ...
  labelOffset: z
    .number()
    .min(0, "Label offset may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelOffset),
  /**
  ...
  labelHoverOffset: z
    .number()
    .min(0, "Label hover offset may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.labelHoverOffset),
  ...
  zoomDuration: z
    .number()
    .min(0, "Zoom duration may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.zoomDuration),
  /**
  ...
  hoverDuration: z
    .number()
    .min(0, "Hover duration may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.hoverDuration),
  /**
   ...
   * 	}```
   */
  nodeDefaultStyle: nodeStyleSchema.partial().optional(),
  /**
   ...
   */
  nodeVisitedStyle: nodeStyleSchema.partial().optional(),
  /**
   ...
   */
  nodeCurrentStyle: nodeStyleSchema.partial().optional(),
  /**
   ...
   */
  nodeUnresolvedStyle: nodeStyleSchema.partial().optional(),
  /**
   ...
   */
  nodeExternalStyle: nodeStyleSchema.partial().optional(),
  /**
   ...
   */
  tagDefaultStyle: nodeStyleSchema.partial().optional(),
  ...
  linkWidth: z
    .number()
    .min(0, "Link width may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.linkWidth),
  /**
  ...
  linkHoverWidth: z
    .number()
    .min(0, "Hover link width may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.linkHoverWidth),
  ...
  arrowSize: z
    .number()
    .min(0, "Arrow size may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.arrowSize),
  /**
  ...
  arrowAngle: z
    ...
    .default(DEFAULT_GRAPH_CONFIG.arrowAngle),
  ...
  centerForce: z
    .number()
    .min(0, "Center force may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.centerForce),
  /**
  ...
  colliderPadding: z
    .number()
    .min(0, "Collider padding may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.colliderPadding),
  /**
  ...
  repelForce: z
    .number()
    .min(0, "Repel force may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.repelForce),
  /**
  ...
  linkDistance: z
    .number()
    .min(0, "Link distance may not be negative")
    .default(DEFAULT_GRAPH_CONFIG.linkDistance),
  /**
  ...
  alphaDecay: z
    ...
    .default(DEFAULT_GRAPH_CONFIG.alphaDecay),
});
export type GraphConfig = z.infer<typeof graphConfigSchema>;

export const globalGraphConfigSchema = graphConfigSchema
  .extend({
    /**
    ...
    visibilityRules: z
      .array(z.string())
      .default(globalGraphConfig.visibilityRules),
  })
  .partial();
