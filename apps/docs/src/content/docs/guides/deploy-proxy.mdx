...
description: Deploy the neuro-ts proxy handler to Cloudflare Workers, Next.js App Router, Fastify, or Express. Web-standard handlers for the proxyUrl contract with OpenAI keys kept server-side.
---
