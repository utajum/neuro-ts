---
title: Quick start
description: Initialize neuro-ts and call a few AI-augmented JavaScript built-ins. TypeScript-first wrappers with optional GPT / OpenAI prompts and native fallback.
---
...
- [Native fallback](/guides/native-fallback/) - what `neuro-ts` does without a prompt.
...
- [Migrate from native](/guides/migrate/) - drop `neuro-ts` into an existing codebase.
- [Error reference](/guides/errors/) - the three error classes and their `cause` shape.
